...
public class ODEException extends O2UException {
  ...
  public ODEException(String description, Class throwerClass) {
    super(description);
    this.throwerClass=throwerClass;
  }

  public ODEException(String description, Class throwerClass, Throwable th) {
