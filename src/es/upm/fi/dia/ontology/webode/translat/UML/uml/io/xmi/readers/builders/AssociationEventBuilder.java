//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\AssociationEventBuilder.java
...
public class AssociationEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Association",
                               "UML:Association.connection"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.AssociationStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.AssociationEnd";
   ...
   * @param factory
   */
  public AssociationEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
