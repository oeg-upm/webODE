//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\AttibuteEventBuilder.java
...
public class AttributeEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Classifier.feature",
                               "UML:Attribute",
  ...
  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.AttributeStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.AttributeEnd";
   ...
   * @param factory
   */
  public AttributeEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
