//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\ClassEventBuilder.java
...
public class ClassEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Class"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.ClassStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.ClassEnd";
   ...
   * @param factory
   */
  public ClassEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
