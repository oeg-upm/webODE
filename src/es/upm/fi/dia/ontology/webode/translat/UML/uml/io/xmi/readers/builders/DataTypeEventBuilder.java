//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\DataTypeBuilder.java
...
public class DataTypeEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:DataType"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.DataTypeStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.DataTypeEnd";
   ...
   * @param factory
   */
  public DataTypeEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
