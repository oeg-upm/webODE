//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\GeneralizationEventBuilder.java
...
public class GeneralizationEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Generalization"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.GeneralizationStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.GeneralizationEnd";
   ...
   * @param factory
   */
  public GeneralizationEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
