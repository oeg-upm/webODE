//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\MultiplicityEventBuilder.java
...
public class MultiplicityEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Multiplicity",
                               "UML:Multiplicity.range",
                               "UML:MultiplicityRange"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.MultiplicityStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.MultiplicityEnd";
   ...
   * @param factory
   */
  public MultiplicityEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
