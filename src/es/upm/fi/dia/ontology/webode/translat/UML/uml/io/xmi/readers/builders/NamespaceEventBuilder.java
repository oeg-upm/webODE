...
public class NamespaceEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Namespace.ownedElement"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.NamespaceStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.NamespaceEnd";
   ...
   * @param factory
   */
  public NamespaceEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
