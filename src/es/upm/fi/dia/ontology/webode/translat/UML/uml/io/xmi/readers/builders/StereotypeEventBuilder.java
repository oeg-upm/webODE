//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\builders\\StereotypeEventBuilder.java
...
public class StereotypeEventBuilder extends DefaultEventBuilder {

  private String[] tags      ={"UML:Stereotype"};
  private HashSet  set       =null;

  private String   startClassName="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.start.StereotypeStart";
  private String   endClassName  ="es.upm.fi.dia.ontology.webode.translat.UML.uml.io.xmi.readers.events.end.StereotypeEnd";
   ...
   * @param factory
   */
  public StereotypeEventBuilder(EventFactory factory) {
    // Create builder
    super(factory);
    // Set up valid tags
    set=new HashSet();
