//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\end\\AssociationEnd.java
...
public class AssociationEnd extends EndElement {
   ...
   * @param qName
   */
  public AssociationEnd(String uri, String name, String qName) {
  ...
  public String prettyString() {
    return "AssociationEnd {uri='"+uri+"', name="+name+"', qName="+qName+"'}";
  }
}
