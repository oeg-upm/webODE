//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\end\\DataTypeEnd.java
...
public class DataTypeEnd extends EndElement {
   ...
   * @param qName
   */
  public DataTypeEnd(String uri, String name, String qName) {
  ...
  public String prettyString() {
    return "DataTypeEnd {uri='"+uri+"', name="+name+"', qName="+qName+"'}";
  }
}
