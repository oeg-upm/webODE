//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\end\\MultiplicityEnd.java
...
public class MultiplicityEnd extends EndElement {
   ...
   * @param qName
   */
  public MultiplicityEnd(String uri, String name, String qName) {
  ...
  public String prettyString() {
    return "MultiplicityEnd {uri='"+uri+"', name="+name+"', qName="+qName+"'}";
  }
}
