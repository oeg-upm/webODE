...
public class NamespaceEnd extends EndElement {
   ...
   * @param qName
   */
  public NamespaceEnd(String uri, String name, String qName) {
  ...
  public String prettyString() {
    return "NamespaceEnd {uri='"+uri+"', name="+name+"', qName="+qName+"'}";
  }
}