//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\end\\StereotypeEnd.java
...
public class StereotypeEnd extends EndElement {
   ...
   * @param qName
   */
  public StereotypeEnd(String uri, String name, String qName) {
  ...
  public String prettyString() {
    return "StereotypeEnd {uri='"+uri+"', name="+name+"', qName="+qName+"'}";
  }
}
