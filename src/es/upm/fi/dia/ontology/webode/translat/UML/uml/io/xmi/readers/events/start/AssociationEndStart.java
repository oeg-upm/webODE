//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\start\\AssociationEndStart.java
...
public class AssociationEndStart extends StartElement {
   ...
   * @param atts
   */
  public AssociationEndStart(String uri, String name, String qName, Attributes atts) {
  ...
  public String toString() {
    return "AssociationEndStart {"+qName+"}";
  }
  ...
  public String prettyString() {
    return "AssociationEndStart {uri='"+uri+
                      "', name='"+name+
                      "', qName='"+qName+
