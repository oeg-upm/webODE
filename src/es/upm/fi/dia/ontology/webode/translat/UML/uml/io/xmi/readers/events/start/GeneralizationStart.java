//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\start\\GeneralizationStart.java
...
public class GeneralizationStart extends StartElement {
   ...
   * @param atts
   */
  public GeneralizationStart(String uri, String name, String qName, Attributes atts) {
  ...
  public String toString() {
    return "GeneralizationStart {"+qName+"}";
  }
  ...
  public String prettyString() {
    return "GeneralizationStart {uri='"+uri+
                      "', name='"+name+
                      "', qName='"+qName+
