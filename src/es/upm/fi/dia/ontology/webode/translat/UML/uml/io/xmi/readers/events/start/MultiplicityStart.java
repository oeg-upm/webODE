//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\start\\MultiplicityStart.java
...
public class MultiplicityStart extends StartElement {
   ...
   * @param atts
   */
  public MultiplicityStart(String uri, String name, String qName, Attributes atts) {
  ...
  public String toString() {
    return "MultiplicityStart {"+qName+"}";
  }
  ...
  public String prettyString() {
    return "MultiplicityStart {uri='"+uri+
                      "', name='"+name+
                      "', qName='"+qName+
