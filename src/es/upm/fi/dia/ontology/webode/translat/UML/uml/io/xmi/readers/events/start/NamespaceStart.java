...
public class NamespaceStart extends StartElement {
   ...
   * @param atts
   */
  public NamespaceStart(String uri, String name, String qName, Attributes atts) {
