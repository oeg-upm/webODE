//Source file: D:\\Trabajo\\xmi\\uml\\io\\xmi\\events\\start\\StereotypeStart.java
...
public class StereotypeStart extends StartElement {
   ...
   * @param atts
   */
  public StereotypeStart(String uri, String name, String qName, Attributes atts) {
  ...
  public String prettyString() {
    return "StereotypeStart {uri='"+uri+
                      "', name='"+name+
                      "', qName='"+qName+
